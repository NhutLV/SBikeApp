...
public class GMapV2Direction {
    ...
    public void getDocument(LatLng start, LatLng end, String mode, final Callback<Document> callback) {
        ...
        new AsyncTask<String, Void, Void>() {
            ...
            protected Void doInBackground(String... params) {
                try {
                    ...
                    Log.d("TAG DIRECTION",e.toString());
                    e.printStackTrace();
                }
                return null;
            }
            ...
            @Override
            protected void onPostExecute(Void document) {
            }
        }.execute(url);
    ...
    class DirectionAsyncTask extends AsyncTask<String,Void,Document>{
